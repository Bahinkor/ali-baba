    ...
    return (
        <div
            ...
            <svg className="hidden">
                ...
                <symbol id="international-flight" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
                        className="block mx-auto mb-1"
                        data-v-ab7fff4c="">
                    <path
                ...
                <symbol id="train" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
                        className="block mx-auto mb-1"
                        data-v-ab7fff4c="">
                    <path
                ...
                <symbol id="bus" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
                        className="block mx-auto mb-1"
                        data-v-ab7fff4c="">
                    <path
                ...
                <symbol id="tour" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
                        className="block mx-auto mb-1"
                        data-v-ab7fff4c="">
                    <path
                ...
                <symbol id="hotel" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
                        className="block mx-auto mb-1"
                        data-v-ab7fff4c="">
                    <path
                ...
                <symbol id="villa" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
                        className="block mx-auto mb-1"
                        data-v-ab7fff4c="">
                    <path
                        d="M12.7477 9.91098C12.7477 9.49677 12.4119 9.16098 11.9977 9.16098C11.5835 9.16098 11.2477 9.49677 11.2477 9.91098V10.9195C11.2477 11.3337 11.5835 11.6695 11.9977 11.6695C12.4119 11.6695 12.7477 11.3337 12.7477 10.9195V9.91098Z"></path>
                    <path
