...
export default function ProductsBox({children}) {
    //JSX
    return (
        <div className="w-[80%] border-solid border-[1px] border-gray-300 bg-red-500 mx-auto">
            {/* svg */}
            <svg className="hidden">
                <symbol id="internal-airplane" viewBox="0 0 24 24" width="36px" height="36px" fill="currentColor"
